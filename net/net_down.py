...
# config
INDEX_PAGE = 'http://www.p6love.com/thread.php?fid=39&search=&page='
HOST = 'http://www.p6love.com'
VOA_DIR = os.path.join('D:\\download', 'VOA')
RETRY_TIMES = 3
...
print 'From %s parsing themes ...' % (INDEX_PAGE+"1")
